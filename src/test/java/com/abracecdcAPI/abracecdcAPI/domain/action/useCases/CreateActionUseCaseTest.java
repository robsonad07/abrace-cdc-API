...
public class CreateActionUseCaseTest {
  ...
  public void should_be_able_to_create_an_actionA() {
    ...
    assertEquals(actionCreated.getAddressEntity(), captureAction.getAddressEntity());
  ...
  @Test
  @DisplayName("Should be able to create an action with a non existent address")
  public void should_not_be_able_to_create_an_action_with_a_non_existent_address() {
    var categoryId = UUID.randomUUID();
    var organizerId = UUID.randomUUID();
    var addressId = UUID.randomUUID();
